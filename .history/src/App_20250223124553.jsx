    ...
    <div className={`${darkMode ? "bg-gray-900 text-white" : "bg-gray-100 text-gray-900"} min-h-screen`}> 
      ...
      <div className="flex">
        ...
        <div className={`flex-1 max-w-2xl mx-auto mt-10 p-6 shadow-lg rounded-lg border ${darkMode ? "bg-gray-800 text-white border-gray-700" : "bg-white text-gray-900 border-gray-200"}`}>
          ...
          <BudgetForm onAddExpense={handleAddExpense} darkMode={darkMode} budget={budget} remainingBudget={remainingBudget}/> {/* Add BudgetForm */}
          <ExpenseList expenses={expenses} onDeleteExpense={handleDeleteExpense} />
          <BudgetProgress budgetUsed={((budget - remainingBudget) / budget) * 100} darkMode={darkMode} />
