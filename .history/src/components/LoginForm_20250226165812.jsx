...
const LoginForm = ({ onAuthSuccess, onToggle }) => {
  ...
  return (
    ...
    <motion.div 
      ...
      className="max-w-md w-full mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg items-center"
    >
    {/* ✅ Logo */}
    <img src="/images/logo.png" alt="Budget Planner Logo" className="w-24 mb-4 items-center" />
