...
const BudgetForm = ({ onAddExpense, darkMode, budget, remainingBudget }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (!amount || (!category && !customCategory) || remainingBudget === 0) return;
  ...
  return (
    <form onSubmit={handleSubmit} className="mb-4">
      ...
      <input
        ...
        disabled={isDisabled} // 🔹 Disable when budget is over
        required
      />
...
BudgetForm.propTypes = {
  ...
  remainingBudget: PropTypes.number.isRequired, // 🔹 Added remainingBudget prop validation
};
