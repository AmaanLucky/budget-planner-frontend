...
const LoginForm = ({ onAuthSuccess, onToggle }) => {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen justify-center bg-gray-100 dark:bg-gray-900 p-4">
      {/* ✅ Project Logo (Same as Navbar) */}
      <motion.div
        ...
        className="mb-6"
      >
        <img src="/logo.svg" alt="Project Logo" className="w-16 h-16" />
      </motion.div>
      ...
      <motion.div
        ...
        className="max-w-md w-full bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg"
      >
