  ...
  return (
    <div className={`${darkMode ? "bg-gray-900 text-white" : "bg-gray-100 text-gray-900"} min-h-screen`}>
      ...
      <div className="flex gap-6 p-6">
        {/* Left Sidebar */}
        <aside className={`w-64 h-screen p-5 shadow-md 
        ...
        <div className={`flex-1 max-w-2xl p-6 shadow-lg rounded-lg border 
        ...
        <div className={`w-1/3 max-h-screen overflow-y-auto p-6 shadow-md border-l rounded-lg 
